//CONDITION: DURATION with the train block FIRST

//timeline for the main task - only in case pretraining is successful
var main_task_dur_train = [];
...
timeline_dur_train.push(consent);
...
timeline_dur_train.push(preload_train);
...
timeline_dur_train.push(welcome);
...
timeline_dur_train.push(survey_age);
...
timeline_dur_train.push(survey);
...
timeline_dur_train.push(instructions_general);
...
var stimulus_min = ["video/17s_small_1.mp4", "video/17s_small_4.mp4"];
var stimulus_max = ["video/23s_large_3.mp4", "video/23s_large_4.mp4"];
...
timeline_dur_train.push(min_presentation);
...
timeline_dur_train.push(min_message)
...
timeline_dur_train.push(max_presentation);
...
timeline_dur_train.push(max_message)
...
timeline_dur_train.push(instructions_pre)
...
timeline_dur_train.push(pre_training);
...
main_task_dur_train.push(instructions_main);

//Success timeline the timeline for the main task is added here
var success = {
    timeline: main_task_dur_train,
    conditional_function: function(){
        var n_correct = jsPsych.data.get().filter({correct: true}).count();
        if (n_correct >= 2){
            return true;
...
timeline_dur_train.push(pre_repeat);
...
main_task_dur_train.push(train_block);
...
main_task_dur_train.push(message);
...
main_task_dur_train.push(preload_notrain);
...
main_task_dur_train.push(message_after_preload);
...
var stimuli_notrain ={
    ...
    main_task_dur_train.push(notrain_block);
...
var debrief_1 ={
 ...
 main_task_dur_train.push(debrief_1);
...
main_task_dur_train.push(debrief_2); 
...
main_task_dur_train.push(debrief_3);
